...
**다만 t\*도 만능이 아니다.** DILI는 t\*가 0.712로 올라가면서 민감도가 0.94→0.66으로 **악화**된다(valid가 54~65분자로 작아 t\* 자체가 불안정하다). ADME에서도 t\*가 악화시키는 엔드포인트가 4개 있다(BBB 0.95→0.76 등). **소표본에서는 임계값 튜닝도 믿을 수 없다.**
...
| ⑦ | "배설 3종 4세대 우세" *(철회된 표현)* | **반감기만 뚜렷**(Δ0.156 > SD). 간세포 청소율 Δ0.0025 ≪ SD 0.0514, 마이크로솜 Δ0.0258 < SD 0.0288 → 동률. 원문 자기평가: *"방향은 진짜 · 표현 과했음"* | 효과크기 vs 표준편차 대조 | `adme_full/notes.md` 축① |
